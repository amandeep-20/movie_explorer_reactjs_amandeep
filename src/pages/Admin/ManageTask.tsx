              ...
              <Box sx={{ display: "flex", flexDirection: "column", gap: 2.5 }}>
                ...
                <Box sx={{ display: "flex", flexDirection: { xs: "column", md: "row" }, gap: 2.5 }}>
                  <Box sx={{ flex: 1 }}>
                    <Autocomplete
                      freeSolo
                      options={directorSuggestions}
                      value={formData.director}
                      onChange={(event, newValue) => {
                        setFormData((prev) => ({ ...prev, director: newValue || "" }));
                      }}
                      onInputChange={(event, newInputValue) => {
                        setFormData((prev) => ({ ...prev, director: newInputValue }));
                      }}
                      renderInput={(params) => (
                        <TextField
                          {...params}
                          ...
                          variant="outlined"
                          required
                          placeholder="Enter or select director's name"
                          InputProps={{
                            ...params.InputProps,
                            sx: {
                              backgroundColor: "rgba(0,0,0,0.2)",
