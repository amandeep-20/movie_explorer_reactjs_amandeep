...
const UserProfile = () => {
  ...
  const calculateDaysBetween = (startDate: string | null, endDate: string | null): number => {
                            ...
                            <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                              {subscriptionPlan === 'premium' ? (
                                <>
                                  ...
                                  >
                                    {calculateDaysBetween(createdAt, expiresAt)} {getDayLabel(calculateDaysBetween(createdAt, expiresAt))}
                                  </Typography>
                                  <Typography variant="h4" sx={{ fontWeight: 'bold', color: 'secondary.main', mb: 2 }}>
                                    Active
                                  </Typography>
